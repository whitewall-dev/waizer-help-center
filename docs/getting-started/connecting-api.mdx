...
O processamento de IA é assíncrono. Aguarde alguns minutos. Conversas com menos de 5 mensagens trocadas (entre bot e usuário) podem não gerar análise completa.
